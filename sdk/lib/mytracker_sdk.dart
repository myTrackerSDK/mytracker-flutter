...
class MyTracker {
  ...
  static Future<bool> isDebugMode() => _apiCnannel.invokeMethod("isDebugMode").then((value) => value);

  /// Enables or disable printing debug information.  If [debugMode] true,
  /// the tracker prints debug information to LogCat.
  static Future setDebugMode(bool debugMode) => _apiCnannel.invokeMethod("setDebugMode", {"value": debugMode});
  ...
  static Future init(String id) => _apiCnannel.invokeMethod("init", {"id": id});
  ...
  static Future trackEvent(String name, Map<String, String>? eventParams) => _apiCnannel.invokeMethod("trackEvent", {"name": name, "eventParams": eventParams});
  ...
  static Future trackLoginEvent(String userId, Map<String, String>? eventParams) => _apiCnannel.invokeMethod("trackLoginEvent", {"userId": userId, "eventParams": eventParams});
  ...
  static Future trackRegistrationEvent(String userId, Map<String, String>? eventParams) =>
      _apiCnannel.invokeMethod("trackRegistrationEvent", {"userId": userId, "eventParams": eventParams});
...
class MyTrackerConfig {
  ...
  Future<String> getId() => _apiCnannel.invokeMethod("getId").then((value) => value);
  ...
  Future<int> getBufferingPeriod() => _apiCnannel.invokeMethod("getBufferingPeriod").then((value) => value);
  ...
  /// call.
  Future<MyTrackerConfig> setBufferingPeriod(int bufferingPeriodSec) => _apiCnannel.invokeMethod("setBufferingPeriod", {"value": bufferingPeriodSec}).then((value) => this);
  ...
  Future<int> getForcingPeriod() => _apiCnannel.invokeMethod("getForcingPeriod").then((value) => value);

  /// Sets the forcing period [forcingPeriodSec] in seconds. The value should
  /// be in range [0 - 432000]. Otherwise it will be  rejected.
  /// NOTE: it's recommended to call this method before [MyTracker.init(id)]
  Future<MyTrackerConfig> setForcingPeriod(int forcingPeriodSec) => _apiCnannel.invokeMethod("setForcingPeriod", {"value": forcingPeriodSec}).then((value) => this);
  ...
  /// Default value is 30.
  Future<int> getLaunchTimeout() => _apiCnannel.invokeMethod("getLaunchTimeout").then((value) => value);

  /// Sets the launch timeout [seconds] in seconds.
  ///
  /// NOTE: it's recommended to call this method before [MyTracker.init(id)]
  Future<MyTrackerConfig> setLaunchTimeout(int seconds) => _apiCnannel.invokeMethod("setLaunchTimeout", {"value": seconds}).then((value) => this);
  ...
  Future<MyTrackerConfig> setProxyHost(String? proxyHost) => _apiCnannel.invokeMethod("setProxyHost", {"value": proxyHost}).then((value) => this);
  ...
  /// MyTracker.init(id)
  /// ```
  Future<MyTrackerConfig> setRegion(MyTrackerRegion region) => _apiCnannel.invokeMethod("setRegion", {"value": region.index}).then((value) => this);
  ...
  Future<bool> isTrackingEnvironmentEnabled() => _apiCnannel.invokeMethod("isTrackingEnvironmentEnabled").then((value) => value);
  ...
  Future<MyTrackerConfig> setTrackingEnvironmentEnabled(bool trackingEnvironmentEnabled) =>
      _apiCnannel.invokeMethod("setTrackingEnvironmentEnabled", {"value": trackingEnvironmentEnabled}).then((value) => this);

  /// Returns whether tracking application launches is enabled or not.
  Future<bool> isTrackingLaunchEnabled() => _apiCnannel.invokeMethod("isTrackingLaunchEnabled").then((value) => value);
  ...
  Future<MyTrackerConfig> setTrackingLaunchEnabled(bool trackingLaunchEnabled) =>
      _apiCnannel.invokeMethod("setTrackingLaunchEnabled", {"value": trackingLaunchEnabled}).then((value) => this);

  /// Returns whether collecting current location is enabled or not.
  ///
  /// NOTE: this information are collected while sending request
  /// to the server. The impact to the battery is minimal.
  Future<bool> isTrackingLocationEnabled() => _apiCnannel.invokeMethod("isTrackingLocationEnabled").then((value) => value);
  ...
  Future<MyTrackerConfig> setTrackingLocationEnabled(bool trackingLocationEnabled) =>
      _apiCnannel.invokeMethod("setTrackingLocationEnabled", {"value": trackingLocationEnabled}).then((value) => this);
}
...
class MyTrackerParams {
  ...
  Future<int?> getAge() => _apiCnannel.invokeMethod("getAge").then((value) => value);

  /// Sets age [age] for the current user.
  Future<MyTrackerParams> setAge(int? age) => _apiCnannel.invokeMethod("setAge", {"value": age}).then((value) => this);

  /// Returns gender of the current user.
  /// Possible values are defined in [MyTrackerGender]
  Future<MyTrackerGender> getGender() => _apiCnannel.invokeMethod("getGender").then((value) => MyTrackerGender.values[value]);
  ...
  /// ```
  Future<MyTrackerParams> setGender(MyTrackerGender gender) => _apiCnannel.invokeMethod("setGender", {"value": gender.index}).then((value) => this);

  /// Returns current language. The value can differ from the
  /// current language of the system.
  Future<String?> getLang() => _apiCnannel.invokeMethod("getLang").then((value) => value);

  /// Sets current language [lang]. You could use this method to
  /// override the system value of the language.
  Future<MyTrackerParams> setLang(String? lang) => _apiCnannel.invokeMethod("setLang", {"value": lang}).then((value) => this);

  /// Returns identifiers of the current user.
  Future<List<String>?> getCustomUserIds() => _apiCnannel.invokeMethod("getCustomUserIds").then((value) => value == null ? null : List.from(value));

  /// Sets the array of  identifiers of the current user [customUserIds].
  Future<MyTrackerParams> setCustomUserIds(List<String>? customUserIds) => _apiCnannel.invokeMethod("setCustomUserIds", {"value": customUserIds}).then((value) => this);

  /// Returns tracked emails of the current user, previously set in [setEmails]
  Future<List<String>?> getEmails() => _apiCnannel.invokeMethod("getEmails").then((value) => value == null ? null : List.from(value));

  /// Sets list of emails [emails] of the current user.
  Future<MyTrackerParams> setEmails(List<String>? emails) => _apiCnannel.invokeMethod("setEmails", {"value": emails}).then((value) => this);

  /// Returns tracked phones of the current user, previously set in [setPhones]
  Future<List<String>?> getPhones() => _apiCnannel.invokeMethod("getPhones").then((value) => value == null ? null : List.from(value));

  /// Sets list of phone numpers [phones] of the current user.
  Future<MyTrackerParams> setPhones(List<String>? phones) => _apiCnannel.invokeMethod("setPhones", {"value": phones}).then((value) => this);
}
